...
SPComponentLoader.loadCss(`https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/CSS/DefinitionStyle.css?v=2.2`);
SPComponentLoader.loadCss(`https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/CSS/responsive.css?v=1.5`);
...
export default class TaqeefDefinitions extends React.Component<ITaqeefDefinitionsProps,ITaqeefDefinitionsState,{}> {    
  ...
  public getDefinitionsMaster(){   
    ...
    $.ajax({
      url: "https://taqeef.sharepoint.com/sites/OPR/ACModel/_api/web/lists/GetByTitle('DefinitionsMaster')/fields?$filter=EntityPropertyName eq 'Department' or EntityPropertyName eq 'Division'",
      type: "GET",
      headers: {
  ...
  const ProductResults: JSX.Element[] = this.state.Data.map(function (item, key) {  
    ...
    for(var i = 0; i <item.Category.length; ){          
      ...
      if(item.Category[i]=="Novair"){          
        var Clivetbrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/NovAir.png";
        setTimeout(() => {
      ...
      if(item.Category[i]=="Clint"){          
        var Clivetbrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/clint.png";
        setTimeout(() => {
          if ($(`.Clint-clas-${key}`)[0]){
            // Do something if class exists
          } else {
