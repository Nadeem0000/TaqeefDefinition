...
SPComponentLoader.loadCss(`https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/CSS/DefinitionStyle.css?v=1.20`);
SPComponentLoader.loadCss(`https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/CSS/responsive.css?v=1.3`);
...
export default class TaqeefDefinitions extends React.Component<ITaqeefDefinitionsProps,ITaqeefDefinitionsState,{}> {    
  ...
  public getDefinitionsMaster(){   
    ...
    $.ajax({
      url: "https://taqeef.sharepoint.com/sites/OPR/ACModel/_api/web/lists/GetByTitle('DefinitionsMaster')/fields?$filter=EntityPropertyName eq 'Product' or EntityPropertyName eq 'Department' or EntityPropertyName eq 'Division' or EntityPropertyName eq 'Tags'",
      type: "GET",
      headers: {
      ...
      success: function (data) {    
        for(var j = 0; j < data.d.results.length; j++){ 
          ...
          else if(data.d.results[j].InternalName == "Department"){                   
  ...
  public GetQueryResults(QueryString){
    NewWeb.lists.getByTitle("DefinitionsMaster").items.select("Term","Description","Product","Department","Division","Tags").
    filter("substringof('" + QueryString + "',Term) or substringof('" +QueryString+ "',Product) or substringof('" +QueryString+ "',Division) or substringof('" +QueryString+ "',Department) or substringof('" +QueryString+ "',Tags)").get()
    .then((items)=>{
      if(items.length==0){
        $(".margin-top").hide();
        $("#no-result").show();
...
this.DefinitionMasterSerach();
  ...
  public getproductsegmentationfilter(){
    ...
    var handler=this;
    $.ajax({
      url: "https://taqeef.sharepoint.com/sites/OPR/ACModel/_api/web/lists/GetByTitle('ProductSegmentation')/fields?$filter=EntityPropertyName eq 'Group' or EntityPropertyName eq 'Category' or EntityPropertyName eq 'ProductVariants'",
      type: "GET",
      headers: {
        "accept": "application/json;odata=verbose",
      },
  ...
  public FilterBasedonAllProduct(SelcectedProduct){
    var QueryString = $.trim($("#txt-Search").val());
    NewWeb.lists.getByTitle("DefinitionsMaster").items.select("Term","Description","Product","Department","Division","Tags").
    filter("Product eq '"+SelcectedProduct+"' and substringof('" + QueryString + "',Term) or substringof('" +QueryString+ "',Division) or substringof('" +QueryString+ "',Department) or substringof('" +QueryString+ "',Tags)").get()       
    .then((items)=>{
 ...
 public DefinitionMasterSerach(){  
  ...
  public masterdefinitionfilter(){
    $("#Search-err").hide();
    if($("#def-Division").length == 1 || $("#def-Department").length == 1 || $("#def-Tag").length == 1) {
      $(".Filter_button").show();
    }
  ...
  public DefinitionSearchAfterFilter(){  
    ...
    NewWeb.lists.getByTitle("DefinitionsMaster").items.select("Term","Description","Product","Department","Division","Tags").
    filter(""+filterquery+" substringof('" + QueryString + "',Term) or substringof('" +QueryString+ "',Division) or substringof('" +QueryString+ "',Product) or substringof('" +QueryString+ "',Tags)").get()
    .then((items)=>{
      this.setState({value:items}); 
      if(items.length==0){
        $(".margin-top").hide();
  ...
  const ProductResults: JSX.Element[] = this.state.Data.map(function (item, key) {  
    ...
    for(var i = 0; i <item.Category.length; ){          
      if(item.Category[i]=="General"){              
        var Genralbrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/brand-1.png";
        setTimeout(() => {
          if ($(`.generalimg-clas-${key}`)[0]){
            // Do something if class exists
          } else {
            $("#"+item.Id+"-Brand-availability").append(`<img class="brand-img generalimg-clas-${key}" src=${Genralbrand} alt="Test"></img>`);
          }          
        }, 100);              
      }
      if(item.Category[i]=="Midea"){             
        var Mideabrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/brand-2.png";
        setTimeout(() => {
          if ($(`.mideaimg-clas-${key}`)[0]){
            // Do something if class exists
          } else {
            $("#"+item.Id+"-Brand-availability").append(`<img class="brand-img mideaimg-clas-${key}" src=${Mideabrand} alt="Test"></img>`);
          }          
        }, 100);          
      }
      if(item.Category[i]=="Clivet"){          
        var Clivetbrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/clivet.png";
        setTimeout(() => {
          if ($(`.Clivetimg-clas-${key}`)[0]){
            // Do something if class exists
          } else {
            $("#"+item.Id+"-Brand-availability").append(`<img class="brand-img Clivetimg-clas-${key}" src=${Clivetbrand} alt="Test"></img>`);
          }          
        }, 100);          
      }
      if(item.Category[i]=="Trosten"){              
        var Trostenbrand="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/trosten.png";
        setTimeout(() => {
          if ($(`.Trostenimg-clas-${key}`)[0]){
            // Do something if class exists
          } else {
            $("#"+item.Id+"-Brand-availability").append(`<img class="brand-img Trostenimg-clas-${key}" src=${Trostenbrand} alt="Test"></img>`);
          }          
        }, 100);
      }
      i++;
    ...
    return(
      <div className={ styles.taqeefDefinitions }>
        <div className="container-block">
          <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/bannerimg.png" alt="MicrosoftTeams-image" className="top-banner"/>
          <div className="top-left top-left-logo">
            <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/logo.png" className="logo" alt="MicrosoftTeams-image"/>
          </div>
            ...
            <div className="topnav">
              ...
              <div className="icon-bar">           
                <a href="#" className="def-class" data-tip data-for={"React-tooltip-definition"} data-custom-class="tooltip-custom" onClick={()=>this.DefinitionMasterSerach()}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/definition.svg"  alt="definition-image"/>
                </a>
                ...
                <a href="#" className="prod-class" data-tip data-for={"React-tooltip-product"} data-custom-class="tooltip-custom" onClick={()=>this.ProductSearchMaster()}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/product%20(1).svg" alt="product-image"/>
                </a>
                ...
                <a className="all-search" href="#" data-tip data-for={"React-tooltip-all"}  data-custom-class="tooltip-custom">
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/menu.png" alt="MicrosoftTeams-image" onClick={()=>this.getEnteredQueryString()}/>
                </a>
                <ReactTooltip id={"React-tooltip-all"} place="bottom" type="dark" effect="solid">
                  <span>All</span>
                </ReactTooltip> 
                <a href="#" data-tip data-for={"React-tooltip-onedrive"} data-custom-class="tooltip-custom" className="anchor-drive" onClick={() => this.SearchDrive($.trim($("#txt-Search").val()))}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/cloud%20(1).png" alt="MicrosoftTeams-image"/>
                </a>
                <ReactTooltip id={"React-tooltip-onedrive"} place="bottom" type="dark" effect="solid">
                  <span>OneDrive</span>
                </ReactTooltip>
                <a href="#" data-tip data-for={"React-tooltip-sharepoint"} data-custom-class="tooltip-custom" className="anchor-sp" onClick={() => this.SearchSharePoint($.trim($("#txt-Search").val()))}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/share%20(1).png" alt="MicrosoftTeams-image"/>
                </a>
                <ReactTooltip id={"React-tooltip-sharepoint"} place="bottom" type="dark" effect="solid">
                  <span>SharePoint</span>
                </ReactTooltip>
                <a href="#" data-tip data-for={"React-tooltip-calendar"} data-custom-class="tooltip-custom" className="anchor-calendar" onClick={() => this.SearchEvents($.trim($("#txt-Search").val()))}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/calendar.png"className= "zoom" alt="MicrosoftTeams-image"/>
                </a>
                <ReactTooltip id={"React-tooltip-calendar"} place="bottom" type="dark" effect="solid">
                  <span>Calendar</span>
                </ReactTooltip>
                <a href="#" data-tip data-for={"React-tooltip-email"} data-custom-class="tooltip-custom" className="anchor-email" onClick={() => this.SearchMessages($.trim($("#txt-Search").val()))}>
                  <img src="https://taqeef.sharepoint.com/sites/OPR/ACModel/SiteAssets/DefinitionAssets/Image/document.png" className= "zoom" alt="MicrosoftTeams-image"/>
                </a>
